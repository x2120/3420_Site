...
<div class='center'>
	...
	<div class="toplogo">
		<img src="movie-reel.jpg" alt="reel" style="width:100px;height:80px;">
	</div>
	...
	<div class='left'>
		...
		<ul>
			...
			<li class='button'><a href="leave.php">Delete Account</a></li>
			<li class='button'><a href="addVid.html">Add Video</a></li>
			<li class='button'><a href="editVid.html">Edit Video</a></li>
			<li class='button'><a href="deleteVid.php">Delete Video</a></li>
			...
			<li class='button' ID='inv_button'><a href="logout.php">Logout</a></li>
		</ul>
	</div>
